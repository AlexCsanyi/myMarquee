...
function marqueeMultiPanel() {
  ...
  $(".marquee_nav div").on("click", function() {
    ...
    $(".marquee_stage_large").append(
      '<div class="marquee_container_2" style="opacity: 0;"></div>'
    );
    $(".marquee_container_2")
      .html(marqueeVars.panelContent[navClicked])
      .animate({ opacity: 1 }, marqueeVars.duration, function() {
        $(".marquee_container_1").remove();
        $(this)
          .addClass("marquee_container_1")
          .removeClass("marquee_container_2");
      });
  });
